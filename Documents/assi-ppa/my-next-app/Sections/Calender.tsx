...
export default function Calender() {
    ...
    return (
        <>
            <div className={`flex flex-row max-md:flex-col ${!theme?'bg-white':''}`}>
                ...
                <div className='w-1/2 p-7 max-md:w-full max-md:p-7'>
                    <div className={`text-3xl font-semibold pt-4  max-md:text-center ${theme?'text-gray-700':'text-green-600'}`}>How to design your site footer like<br /> we did</div>
                    <div className={`mt-4 text-sm pr-28 max-md:text-center max-md:pr-0 ${!theme?'text-black':""}`}>
